...
## Índice complementar da análise desta sessão

Os documentos abaixo foram criados no repositório de análise para organizar a Etapa 1 e a documentação técnica, sem alterar o sistema avaliado:

- [Análise do sistema](01-requisitos/analise-sistema.md)
- [Objetivo da avaliação](01-requisitos/objetivo-avaliacao.md)
- [Software avaliado](01-requisitos/software-avaliado.md)
- [Características ISO/IEC 25010](01-requisitos/caracteristicas-iso25010.md)
- [Arquitetura do sistema](docs/arquitetura.md)
- [Stack técnico](docs/stack-tecnico.md)
- [Funcionalidades do sistema](docs/funcionalidades.md)
- [Relatório em PDF](docs/anexos/README.pdf)
- [Relatório consolidado de resultados](04-resultados/resultado.md)

## Estrutura criada no repositório de análise

- [01-requisitos](01-requisitos)
- [02-metricas](02-metricas)
- [03-plano](03-plano)
- [04-resultados](04-resultados)
- [templates](templates)
- [slides](slides)
- [docs](docs)
...
![Tela Inicial do Sistema - StoreDog](01-requisitos/imagens/Tela%20sistema.png)
...
![Mapa da Arquitetura demonstrando estado crítico no Frontend (Cenário Base)](04-resultados/cenario-quebrado/O%20Mapa%20do%20Problema.png)
![Mapa da Arquitetura demonstrando operação saudável (Cenário Corrigido)](04-resultados/cenario-correto/O%20Mapa%20corrigido.png)
...
![Gráfico evidenciando alta taxa de Erros 500 (Cenário Base)](04-resultados/cenario-quebrado/Erro%20grafico.png)
![Gráfico evidenciando ausência de Erros e estabilidade (Cenário Corrigido)](04-resultados/cenario-correto/Erro%20grafico.png)
...
![Gráfico de Latência apontando lentidão severa acima de 2.5s (Cenário Base)](04-resultados/cenario-quebrado/Latencia.png)
![Gráfico de Latência evidenciando resposta otimizada em 6.79ms (Cenário Corrigido)](04-resultados/cenario-correto/Latencia.png)
...
![Lista de Spans evidenciando a anomalia N+1 com centenas de consultas repetidas (Cenário Base)](04-resultados/cenario-quebrado/Spam%20List.png)
![Lista de Spans otimizada com 80% de redução nas idas ao banco (Cenário Corrigido)](04-resultados/cenario-correto/Spam%20List.png)
